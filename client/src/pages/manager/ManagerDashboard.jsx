...
const ManagerDashboard = () => {
  ...
  const quickLinks = [
    { label: '📦 Manage Products', path: '/manager/products', color: 'bg-blue-500' },
    { label: '🏭 Manage Inventory', path: '/manager/inventory', color: 'bg-green-500' },
    { label: '👥 Manage Customers', path: '/manager/customers', color: 'bg-yellow-500' },
    { label: '📊 View Reports', path: '/manager/reports', color: 'bg-purple-500' },
  ];
